...
type TeamConversationCapabilitySnapshot = {
  ...
  context_relay_source_id?: string;
};
...
const AionrsTeamChat: React.FC<{
  ...
  return (
    <AionrsChat
      ...
      historySourceConversationId={conversation.extra.context_relay_source_id}
    />
  );
};
      ...
      case 'acp':
        return (
          <AcpChat
            ...
            historySourceConversationId={capabilitySnapshot?.context_relay_source_id}
            initialModelId={initialModelId}
            routedModelInfo={routedModelInfo}
            onCurrentModelIdChange={onCurrentModelIdChange}
          />
        );
      case 'aionrs':
        return (
