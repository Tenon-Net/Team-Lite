...
import { Brain, Swords, UserPlus } from '@/renderer/components/icons';
import type { LucideIcon } from '@/renderer/components/icons';
        ...
        <div className='flex flex-col gap-6px w-full'>
          {SUGGESTIONS.map((s) => {
            ...
            return (
              ...
              >
                <s.Icon size={15} className='shrink-0 text-t-secondary' />
