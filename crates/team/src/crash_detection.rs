...
mod tests {
    use super::*;
    use acp::protocol::events::{ErrorEventData, StartEventData};
...
mod crash_tests {
    use super::*;
    use acp::protocol::events::ErrorEventData;
    ...
    fn detect_crash_non_error_returns_none() {
        let event = AgentStreamEvent::Start(acp::protocol::events::StartEventData { session_id: None });
