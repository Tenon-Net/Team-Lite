...
use team::{Mailbox, TaskBoard, TeamAgent, TeamMcpServer, TeamPromptDumpConfig, TeammateManager, TeammateRole};
...
async fn sb1_bridge_config_generation() {
    use team::{TeamMcpStdioConfig, TeamMcpStdioServerSpec};
